...
function RichInput(_ref) {
  ...
  }), (options.length > 0 || hasAddressBook) && renderDropdown()), readonly && copy && /*#__PURE__*/React.createElement(Tooltip$1, {
    title: copyTooltip,
    placement: "top",
    arrow: true
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(CopyIcon, null)))))), Boolean(error) && /*#__PURE__*/React.createElement("div", {
...
var EditAddressForm = function EditAddressForm(_ref5) {
  ...
  var _useState19 = useState(selectedAddress.label || ""),
      _useState20 = _slicedToArray(_useState19, 2),
      name = _useState20[0],
      setName = _useState20[1];

  var _useState21 = useState(selectedAddress.value || ""),
...
function AppsMenu(props) {
  ...
  return /*#__PURE__*/React.createElement(AppsMenuWrapper, {
    className: "".concat(dark ? "dark" : "light", " ").concat(opened ? "opened" : "")
  }, /*#__PURE__*/React.createElement(Foco, {
    onClickOutside: onClickOutside
  }, /*#__PURE__*/React.createElement("button", {
    className: "apps-menu__toggle",
    onClick: handleToggleClick
  }, /*#__PURE__*/React.createElement(GridIcon, null)), /*#__PURE__*/React.createElement("div", {
    className: "apps-menu__dropdown"
  }, /*#__PURE__*/React.createElement("ul", null, apps.map(function (app) {
    return /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement("a", {
      href: app.url,
      target: app.target || "_self",
      className: "apps-menu__dropdown-item",
      onClick: onClickOutside
    }, app.icon && /*#__PURE__*/React.createElement("img", {
      src: app.icon,
      alt: "".concat(app.name, " icon")
    }), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, app.name), app.description && /*#__PURE__*/React.createElement("span", null, app.description)), /*#__PURE__*/React.createElement(ArrowIcon, null)));
  })))));
}

var AppsMenuWrapper = styled$1("div")({
  position: "relative",
...
export { Alert, AppsMenu, Autocomplete, Button, CircularProgress, Dialog, Drawer, IconButton, Menu, RichInput, Select, SelectSimple, Snackbar, SuffixInput, Switch, Tabs, Text, TextInput, ThemeProvider, Tooltip };
