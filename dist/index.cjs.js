...
var ArrowRightIcon__default =
  /*#__PURE__*/ _interopDefaultLegacy(ArrowRightIcon);
                ...
                ? {
                    ".MuiOutlinedInput-root": {
                      boxShadow: error
                        ...
                        : "inset 0px 0px 0px 1px #0057FF",
                      border: error ? "1px solid #FF5858" : "1px solid #0057FF",
                    },
                  }
                : {
                    ".MuiOutlinedInput-root": {
                      ...
                      startAdornment: !currentValue
                        ? /*#__PURE__*/ React__default["default"].createElement(
                            ...
                            /*#__PURE__*/ React__default[
                              "default"
                            ].createElement(material.Icon, null, "search")
                          )
                        : currentValue.icon
                        ? /*#__PURE__*/ React__default["default"].createElement(
                            "img",
...
function TextInput(_ref) {
  ...
  var changeValue = React.useCallback(
    function (val) {
      onChange(val);
    },
    [onChange]
...
function Select(_ref) {
  ...
  var handleChange = function handleChange(event) {
    onChange(
      multiple
        ? event.target.value.map(function (v) {
            return v.value;
          })
              ...
              material.Select,
              {
                ...
                renderValue: function renderValue() {
                  return /*#__PURE__*/ React__default["default"].createElement(
                    ...
                    (multiple ? currentValue : [currentValue]).map(function (
                      option,
                      i
                    ) {
                      return /*#__PURE__*/ React__default[
...
function RichInput(_ref) {
  ...
  var editor = React.useMemo(function () {
    return withReferences(
      slateReact.withReact(slateHistory.withHistory(slate.createEditor()))
    );
  }, []);
  ...
  var initialValue = React.useMemo(
    function () {
    ...
    return focused
      ? /*#__PURE__*/ React__default["default"].createElement(
          ...
          /*#__PURE__*/ React__default["default"].createElement(
            material.Box,
            null,
            Object.keys(groupedOptions).map(function (key, i) {
              return /*#__PURE__*/ React__default["default"].createElement(
                React__default["default"].Fragment,
                {
                  key: key,
  ...
  var renderOption = function renderOption(option) {
    return /*#__PURE__*/ React__default["default"].createElement(
      material.Box,
      {
        component: "div",
        key: option.value,
        className: "rich-input__dropdown-option ".concat(
      ...
      /*#__PURE__*/ React__default["default"].createElement(
        material.Box,
        {
          ...
          title: ""
            .concat(option.label)
            .concat(option.reference ? ": " + option.reference : ""),
        },
        option.icon
          ? /*#__PURE__*/ React__default["default"].createElement("img", {
              loading: "lazy",
  ...
  var handleOptionDelete = function handleOptionDelete(option) {
    var newAddressBook = _toConsumableArray(
      addressBook.filter(function (address) {
  ...
  return /*#__PURE__*/ React__default["default"].createElement(
    ...
    items.map(function (item) {
      return item.children
        ? /*#__PURE__*/ React__default["default"].createElement(
            muiNestedMenu.NestedMenuItem,
            {
              key: item.key,
              className: "nested-menu-item",
              leftIcon: item.icon,
              rightIcon: /*#__PURE__*/ React__default["default"].createElement(
                ArrowRightIcon__default["default"],
                null
              ),
              label: item.label,
              parentMenuOpen: open,
...
function AppsMenu(props) {
  ...
  return /*#__PURE__*/ React__default["default"].createElement(
    ...
    {
      className: ""
        .concat(dark ? "dark" : "light", " ")
        .concat(opened ? "opened" : ""),
    },
    /*#__PURE__*/ React__default["default"].createElement(
      Foco__default["default"],
      {
      ...
      /*#__PURE__*/ React__default["default"].createElement(
        ...
        /*#__PURE__*/ React__default["default"].createElement(GridIcon, null)
      ),
      /*#__PURE__*/ React__default["default"].createElement(
        "div",
        {
...
var AppsMenuWrapper = styles.styled("div")({
  position: "relative",
...
AppsMenu.propTypes = {
  apps: PropTypes__default["default"].arrayOf(
